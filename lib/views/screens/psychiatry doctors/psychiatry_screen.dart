...
class _PsychiatryScreenState extends State<PsychiatryScreen> {
  List<HomeMostVisitedModel> doctors = [
    HomeMostVisitedModel(AppConstant.doctor4, 'محمد ال جعفر'),
    HomeMostVisitedModel(AppConstant.doctor2, 'ايمان ابا حسن'),
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: PreferredSize(
        ...
        child: AppBarWidthTitle(title: 'اختر الطبيب'),
      ),
                  ...
                  (index) => Padding(
                    ...
                    child: Animate(
                      ...
                      child: PsychotherapyAndPsychiatryCard(
                        ...
                        doctorFor: index == 1 ? '(بالغين)' : '(أطفال)',
                        doctorType: 'الطب النفسي',
