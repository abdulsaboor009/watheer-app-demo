...
import 'package:watheer_demo/views/screens/training%20doctors/components/training_doctors_card.dart';
...
class TrainingDoctors extends StatefulWidget {
  const TrainingDoctors({super.key});

  @override
  State<TrainingDoctors> createState() => _TrainingDoctorsState();
}

class _TrainingDoctorsState extends State<TrainingDoctors> {
  List<HomeMostVisitedModel> doctors = [
    ...
    HomeMostVisitedModel(AppConstant.doctor3, 'د. مرام الطويرقي'),
  ];
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: PreferredSize(
        ...
        child: AppBarWidthTitle(title: 'اختر المشرف'),
      ),
